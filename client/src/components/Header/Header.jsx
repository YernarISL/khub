    ...
    <div className="header-wrapper">
      <div className="header-container">
        ...
        <nav className="header-nav-bar">
          <NavLink to="/myworks">{t("header.myWorks")}</NavLink>
          <NavLink to="/sandbox">{t("header.sandbox")}</NavLink>
          {user.role === "ADMIN" && (
        ...
        <div className="header-profile-section">
          ...
          <Link to="/profile" className="header-profile-username">{user.username}</Link>
        </div>
